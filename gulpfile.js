...
var paths = {
    ...
    distDev: './src/dist.dev',
    distProd: './src/dist.prod',
    distScriptsProd: './src/dist.prod/scripts',
...
gulp.task('sassdef', function () {
    gulp.src('./src/app/style/scss/scss_default/*.scss')
        .pipe(sass())
        .pipe(minifycss({compatibility: 'ie8'}))
        .pipe(gulp.dest('./src/app/style/css/css_default'));
});

gulp.task('sassinv', function () {
    gulp.src('./src/app/style/scss/scss_inverse/*.scss')
        .pipe(sass())
        .pipe(minifycss({compatibility: 'ie8'}))
        .pipe(gulp.dest('./src/app/style/css/css_inverse'));
});
...
gulp.task('clean-build-app-prod', pipes.builtAppProd);
