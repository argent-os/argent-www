(function() {
  ...
  angular.module('app.module.billing', [])
  ...
  // Billing controller
  .controller('BillingController', ['$scope', '$rootScope', '$http', 'DEFAULT_INVOICE', 'DEFAULT_LOGO', 'LocalStorage', 'Currency',
    function($scope, $rootScope, $http, DEFAULT_INVOICE, DEFAULT_LOGO, LocalStorage, Currency) {
    ...
    var vm = this;
    vm.dataAmount = 1000;
    $rootScope.dataDescription="1 Item";
